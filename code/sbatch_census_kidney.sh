...
QUERY_NAME=${1:-kidney}
DATASET="/home/qiliu/data/cellxgene/scb_strict/${QUERY_NAME}/all_counts"
...
LAYERS=12
MODEL_SCALE=8
SAVE_DIR="/home/qiliu/data/single_cell_gpt/save/pretrain_scgpt_on_whole_cellxgene"
...
NUM_GPUS=8
NPROC=${NUM_GPUS}
/home/zqliu/anaconda3/envs/LBM/bin/python -m torch.distributed.launch \
